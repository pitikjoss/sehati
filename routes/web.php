...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::resource('mulais', 'MulaiController');
    Route::get('/tim', 'SuperController@tim');
    Route::get('/atur', 'MulaiController@index');
    Route::post('/ganti', 'MulaiController@atur');
    Route::get('/bantuan', 'SuperController@bantuan');
    Route::get('/peraturan', 'SuperController@peraturan');
