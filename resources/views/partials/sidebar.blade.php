...
<div class="page-sidebar-wrapper">
    <div class="page-sidebar navbar-collapse collapse">
        <ul class="page-sidebar-menu"
            ...
            <li class="{{ $request->segment(1) == 'results' ? 'active' : '' }}">
                <a href="{{ route('results.index') }}">
                    ...
                    <span class="title">@lang('quickadmin.results.title')</span>
                        ...
                        <li class="{{ $request->segment(1) == 'atur' ? 'active' : '' }}">
                <a href="/atur">
                    <i class="fa fa-gears"></i>
                    <span class="title">@lang('quickadmin.mulai')</span>
                </a>
            </li>
            ...
            <li class="{{ $request->segment(1) == 'peraturan' ? 'active' : '' }}">
                <a href="{{ route('peraturans.index') }}">
                    <i class="fa fa-gears"></i>
                    <span class="title">Peraturan</span>
                </a>
            </li>
            <li class="{{ $request->segment(1) == 'bantuan' ? 'active' : '' }}">
                <a href="{{ route('bantuans.index') }}">
                    <i class="fa fa-gears"></i>
...
@else
            ...
            <li class="{{ $request->segment(1) == 'tim' ? 'active' : '' }}">
                <a href="/tim">
                    <i class="fa fa-gears"></i>
                    <span class="title">@lang('quickadmin.tim')</span>
                </a>
            </li>
            ...
            <li class="{{ $request->segment(1) == 'peraturan' ? 'active' : '' }}">
                <a href="/peraturan">
                    <i class="fa fa-gears"></i>
                    <span class="title">@lang('quickadmin.peraturan')</span>
                </a>
            </li>
            ...
            <li class="{{ $request->segment(1) == 'bantuan' ? 'active' : '' }}">
                <a href="/bantuan">
                    <i class="fa fa-gears"></i>
                    <span class="title">@lang('quickadmin.bantuan')</span>
                </a>
            </li>
